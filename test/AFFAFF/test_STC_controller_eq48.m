...
K = [1,-1,-2,0.2,-2,0.2];    % Feedback gain
          ...
          if k > ActuationTime/Tstep
             u_0 = K*X(:,k);
                ...
                %components of A and b 
                        L_f_h_0 =  partial_h_0_partial_x*A*X(:,k);
                        L_f_h_e_1 = partial_h_1_e_partial_x*A*X(:,k);
                        L_f_h_e_2 = partial_h_2_e_partial_x*A*X(:,k);
                        ...
                        h_0 = S(k,m+1,1) - tau*S(k,m+1,2);
                        h_1 = S(k,m+2,1) - tau*S(k,m+2,2);
                        h_2 = S(k,m+3,1) - tau*S(k,m+3,2);
                        h_overline_1 = h_1 -  h_0;
                        h_overline_2 = h_2 -  h_0;


            % Constraints: Ax <= b
                A_QP = [-L_g_h_0, 0, 0; -L_g_h_e_1, -1, 0; -L_g_h_e_2, 0, -1; 0, -1, 0; 0, 0, -1];
